...
14. Phrase infrastructure-facing and other external-executor tasks as direct execution requests with explicit actions and required outputs, not as discovery prompts.
15. Do not ask external executors to decide unresolved business semantics or policy; route that uncertainty as an explicit escalation or follow-up task.
